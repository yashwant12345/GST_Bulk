...
# if os.path.exists("/DriveD/additional_codes/file_with_datetime_L1b.txt"):
# 	os.remove("/DriveD/additional_codes/file_with_datetime_L1b.txt")

# if os.path.exists("/DriveD/additional_codes/file_with_date_only_L1b.txt"):
# 	os.remove("/DriveD/additional_codes/file_with_date_only_L1b.txt")

with open("/DriveD/additional_codes/file_with_date_only_L1b.txt",'r') as rd:
...
for file in listfiles:
	...
	try:
		...
		with open("/DriveD/additional_codes/file_with_datetime_L1b.txt",'a') as ap:
			ap.write(file+"****"+str(folderdate)+"\n")

		with open("/DriveD/additional_codes/file_with_date_only_L1b.txt",'a') as ap:
...
csv_name = "/DriveD/additional_codes/output/gst_L1b_"+str(c_date)+"_New.csv"
